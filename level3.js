...
let startTime = 0;
let gameDuration = 30000; // 30 seconds in milliseconds
...
function startGameWithMusic() {
    outcome_element_w.style.display = 'none';
...
function updateMob() {
    ...
    mob.x += directionX * mob.speed * 0.8;
    mob.y += directionY * mob.speed * 0.7;
...
function updateMob2() {
    ...
    let directionY = dy / distance;
    // Move the mob towards the player by multiplying the direction vector by the mob's speed
    mob2.x += directionX * mob2.speed * 0.85;
    mob2.y += directionY * mob2.speed * 0.75;
    // Check if the mob is out of bounds and adjust its position if necessary
    if (mob2.x < 0) {
        mob2.x = 0;
...
function updateMob3() {
    ...
    let directionY = dy / distance;
    // Move the mob towards the player by multiplying the direction vector by the mob's speed
    mob3.x += directionX * mob3.speed * 0.85;
    mob3.y += directionY * mob3.speed * 0.75;
    // Check if the mob is out of bounds and adjust its position if necessary
    if (mob3.x < 0) {
        mob3.x = 0;
...
let tileSize = 10;
let background = [
    [45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46,45,46],
    [45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46,45,46],
    [45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46,45,46],
    [45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46,45,46],
    [45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46, 45, 46,45,46],
...
function init() {
    ...
    mobImage.src = "fox.png";
    mob2Image.src = "fox.png";
    mob3Image.src = "fox.png";
    window.addEventListener("keydown", activate, false);
    window.addEventListener("keyup", deactivate, false);
    load_assets([
        { "var": playerImage, "url": "devil.png" },
        { "var": backgroundImage, "url": "tiles.png" },
        { "var": mobImage, "url": "fox.png" },
        { "var": mob2Image, "url": "fox.png" },
        { "var": mob3Image, "url": "fox.png" }
    ], draw);
...
function draw() {
    ...
    if (elapsedTimer > gameDuration) {
        outcome_element_w.style.display = 'block';
        console.log(outcome_element_w)   // Show the 'win' message after the game duration
        setTimeout(() => {
            outcome_element_w.style.display = 'none';
            stopGame();
